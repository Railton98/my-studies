...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center space-x-2 ms-2 me-5 rtl:space-x-reverse lg:ms-0"
            wire:navigate>
            <x-app-logo />
        </a>
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item icon="film" :href="route('media.contents.index')"
                :current="request()->routeIs('media.contents.index')" wire:navigate>{{ __('Contents') }}
            </flux:navbar.item>
        </flux:navbar>
